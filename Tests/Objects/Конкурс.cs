...
namespace NewPlatform.ClickHouseDataService.Tests
{
    ...
    public class Конкурс : ICSSoft.STORMNET.DataObject
    {
        ...
        public virtual NewPlatform.ClickHouseDataService.Tests.Состояние Состоятие
        {
            ...
            set
            {
                // *** Start programmer edit section *** (Конкурс.Состоятие Set start)

                // *** End programmer edit section *** (Конкурс.Состоятие Set start)
                this.fСостоятие = value;
                // *** Start programmer edit section *** (Конкурс.Состоятие Set end)

                // *** End programmer edit section *** (Конкурс.Состоятие Set end)
            }
        }
